...
class CustomerServiceImpTest {
	...
	void testregisterComplaint() throws ComplaintNotFoundException {
		...
		customer = new Customer(6, 123456789, "arthy", "M", addr, 908067282, bank);
		customerservice.addCustomer(customer);
		complaint = new Complaint(7, 120, "string", "string", customer);
	
		assertEquals(7, customerservice.registerComplaint(complaint).getComplaintid());
